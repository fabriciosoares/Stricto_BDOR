----------------- Comandos de carga do banco de dados - DML de carga  ----------------------------------------------------------------
...
-- bloco de comando para inserir quatro pessoas fisicas com foto no sistema;
-- OBSERVAÇÃO PARA QUE O MESMO FUNCIONE A PASTA PICTURES QUE VAI EM ANEXO COM OS SCRIPTS
-- DEVERÁ SER COLOCADA NO DIRETÓRIO C:\CARTORIO CASO CONTRÁRIO ELE NÃO ACHARÁ O LOCAL DAS FOTOS.
-- NESSE CASO O SENHOR DEVERÁ ALTERAR O CAMINHO ONDE AS FOTOS ESTÃO ARMAZENADAS NO SEXTO PARÂMETRO DO PROCEDIMENTO.
-- INSERIRPFCOMFOTO
Set serveroutput on;
...
begin
      ...
      INSERIRPFCOMFOTO('Joaquim Barbosa',ARRAY_TELEFONE(TP_TELEFONE('RESIDENCIAL','86','32274563')),
      tp_endereco('Rua elias oca',57,'Lourival Parente','Olinda','PE','64800000'),'87325692978','M',
      'c:\cartorio\picture','pf1h.jpg');
      
      INSERIRPFCOMFOTO('Joana Do Nascimento',ARRAY_TELEFONE(TP_TELEFONE('RESIDENCIAL','85','34334524')),
      tp_endereco('Rua aquino ribeirio',157,'Bodocongo','Campina Grande','PB','64800000'),'46423641102','M',
      'c:\cartorio\pictures','pf1m.jpg');
      
      INSERIRPFCOMFOTO('Francisca da Silva',ARRAY_TELEFONE(TP_TELEFONE('RESIDENCIAL','81','35644263')),
      tp_endereco('Rua almirante tamandare',34,'Boa Viagem','Recife','PE','64800000'),'57673298856','M',
      'c:\cartorio\pictures','pf2m.jpg');
      
      INSERIRPFCOMFOTO('Lineu Antônio Lima',ARRAY_TELEFONE(TP_TELEFONE('RESIDENCIAL','89','33894346')),
      tp_endereco('Rua jose olegario correia',42,'Macauba','Floriano','PI','64800000'),'28533644531','M',
      'c:\cartorio\pictures','pf2h.jpg');
...
--inserindo os cargos dos funcionários do cartório
...
--inserindo as jornadas de trabalho que os funcionários poderão exercer no cartório
...
insert into tb_jornada values(tp_jornada('De 13:30 às 19:30',interval '0 13:30:00' day(0) to second, interval '0 19:30:00' day(0) to second));
insert into tb_jornada values(tp_jornada('De 09:00 às 15:00',interval '0 09:00:00' day(0) to second, interval '0 15:00:00' day(0) to second));
insert into tb_jornada values(tp_jornada('De 08:00 às 14:00',interval '0 08:00:00' day(0) to second, interval '0 14:00:00' day(0) to second));

/
--commit para efetivar os comandos executados;
commit;
/
...
INSERT INTO TB_FUNCIONARIO VALUES(TP_FUNCIONARIO(SYSDATE-10,
...
INSERT INTO TB_FUNCIONARIO VALUES(TP_FUNCIONARIO(SYSDATE-2,
...
(SELECT REF(CT) FROM TB_CARGO CT WHERE CT.DESCRICAO LIKE '%Escrevente%'),NULL,nested_gratificacao(tp_gratificacao(to_date('06/2015','MM/YYYY'),150),tp_gratificacao(to_date('05/2015','MM/YYYY'),150))));


--Jonatas supevisionado por felipe. Jonatas alem disso recebe gratificações por supervisionar auxiliares de cartorio.
INSERT INTO TB_FUNCIONARIO VALUES(TP_FUNCIONARIO(SYSDATE-3,
...
(SELECT REF(CT) FROM TB_CARGO CT WHERE CT.DESCRICAO LIKE '%Escrevente%'),(select ref(f) from tb_funcionario f where f.ref_pessoafisica.cpf='45355537340'),nested_gratificacao(tp_gratificacao(to_date('06/2015','MM/YYYY'),80),tp_gratificacao(to_date('05/2015','MM/YYYY'),50))));

--Henzo supervisionado pelo olavo
INSERT INTO TB_FUNCIONARIO VALUES(TP_FUNCIONARIO(SYSDATE-8,
...
INSERT INTO TB_FUNCIONARIO VALUES(TP_FUNCIONARIO(SYSDATE-1,
...
INSERT INTO TB_FUNCIONARIO VALUES(TP_FUNCIONARIO(SYSDATE-30,
...
--indicando em que setor cada funcionário irá atuar e qual vai ser sua jornada de trabalho 
--(A tabela armazena todo o histórico de setores por onde o funcionário trabalhou e qual foi a sua jornada de trabalho quando 
--passou pelos setor)
...
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula as matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='52454366550'),'Registro Civil','De 07:30 às 17:30',to_date('01/05/2015 18:38:30','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='71698661533'),'Registro Civil','De 07:30 às 12:30',to_date('02/05/2015 18:38:30','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='18267230807'),'Registro de Notas','De 07:30 às 17:30',to_date('03/05/2015 18:38:30','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='67034615624'),'Arquivamento','De 07:30 às 17:30',to_date('04/05/2015 18:20:35','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='79945193937'),'Digitação','De 07:30 às 17:30',to_date('04/05/2015 18:20:30','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='85481536447'),'Recepção','De 07:30 às 17:30',to_date('05/05/2015 18:37:30','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='08185128731'),'Recepção','De 07:30 às 17:30',to_date('05/05/2015 18:37:20','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula as matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='45355537340'),'Geral','De 17:30 às 21:30'));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula as matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='52454366550'),'Registro Civil','De 07:30 às 17:30',to_date('01/07/2015 18:38:30','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='71698661533'),'Registro Civil','De 07:30 às 12:30',to_date('02/07/2015 18:38:30','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='71698661533'),'Arquivamento','De 07:30 às 17:30',to_date('01/12/2009 10:20:30','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='71698661533'),'Arquivamento','De 13:30 às 19:30',to_date('04/07/2009 21:40:10','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='71698661533'),'Digitação','De 09:00 às 15:00',to_date('03/01/2011 11:30:00','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='71698661533'),'Registro de Notas','De 07:30 às 12:30',to_date('12/01/2012 19:30:00','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='71698661533'),'Registro Civil','De 07:30 às 12:30',to_date('07/01/2013 10:32:11','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='18267230807'),'Registro de Notas','De 07:30 às 17:30',to_date('04/07/2011 13:38:30','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='18267230807'),'Recepção','De 08:00 às 14:00',to_date('03/04/2011 17:38:30','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='18267230807'),'Registro de Notas','De 13:30 às 19:30',to_date('03/05/2013 01:13:50','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='67034615624'),'Arquivamento','De 07:30 às 17:30',to_date('04/05/2012 05:20:35','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='67034615624'),'Digitação','De 07:30 às 17:30',to_date('02/12/2014 18:20:35','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='18267230807'),'Registro de Notas','De 07:30 às 17:30',to_date('03/05/2012 11:38:30','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='67034615624'),'Geral','De 07:30 às 17:30',to_date('04/05/2013 12:20:35','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='79945193937'),'Digitação','De 07:30 às 17:30',to_date('04/05/2012 13:20:30','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='85481536447'),'Geral','De 07:30 às 17:30',to_date('01/01/2011 16:13:00','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='85481536447'),'Recepção','De 07:30 às 17:30',to_date('01/01/2015 18:37:30','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='08185128731'),'Registro Civil','De 07:30 às 17:30',to_date('23/03/2006 09:31:20','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='08185128731'),'Registro de Notas','De 07:30 às 17:30',to_date('05/05/2008 08:37:20','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='08185128731'),'Registro Civil','De 13:30 às 19:30',to_date('05/05/2010 07:57:20','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='08185128731'),'Digitação','De 09:00 às 15:00',to_date('12/11/2013 08:37:20','DD/MM/YYYY HH24:MI:ss')));
insert into tb_historico_setor_funcionario values(tp_historico_setor_funcionario((select f.matricula from tb_funcionario f where deref(f.ref_pessoafisica).cpf='08185128731'),'Recepção','De 07:30 às 17:30',to_date('05/05/2015 09:32:20','DD/MM/YYYY HH24:MI:ss')));
...
-- inserir tipos de serviços ofertados no cartório
...
--serviços de registro civil realizados no cartório  
...
insert into tb_servico values(tp_servico('Certidão negativa/positiva de protesto',16.24,'Oficiais de Protesto de Títulos'));  
insert into tb_servico values(tp_servico('Sócio excedente (acima de dois) nas Certidões negativa/positiva de protesto',4.85,'Oficiais de Protesto de Títulos'));  
...
-- serviços Oficiais de Registro de Imóveis realizados no cartorio
...
-- serviços de Tabeliães de Notas realizados no cartorio
...
-- serviços Diversos - Atos Comuns e Isolados realizados no cartorio
...
insert into tb_servico values(tp_servico('Certidão negativa/positiva por pessoa física ou jurídica (individual)',14.60,'Diversos - Atos Comuns e Isolados')); 
...
-- inserir descontos que poderão ser dados a certos serviços ofertados no cartório dependendo do usuário se ele for de baixa renda
...
-- inserir OS LIVROS ONDE SERÃO armazenados os registros de arquivamento de serviços que dependem de arquivamento de documentos 
--no setor de arquivos do cartório
...
/  
--reliza a efetivação das operações de inserções até aqui executadas;
commit;
/
...
--Obs: somente funcionários com o cargo de atendente poderão atender os clientes que chegam no cartório  
...
insert into tb_atendimento values(tp_atendimento('01210449390','85481536447',to_timestamp('01/02/2015 11:00:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '01210449390','WILTON'    
insert into tb_atendimento values(tp_atendimento('53125548632','08185128731',to_timestamp('01/02/2015 12:30:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '53125548632'VERONICA'    
insert into tb_atendimento values(tp_atendimento('36245802997','85481536447',to_timestamp('02/03/2015 13:00:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '36245802997'CAROLINA'
insert into tb_atendimento values(tp_atendimento('93097207511','08185128731',to_timestamp('02/03/2015 14:30:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '93097207511'MARIANA'      
insert into tb_atendimento values(tp_atendimento('51492421448','85481536447',to_timestamp('25/04/2015 15:00:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '51492421448'VALERIA'
insert into tb_atendimento values(tp_atendimento('12084546923','08185128731',to_timestamp('25/04/2015 16:30:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '12084546923''JOÃO'          
insert into tb_atendimento values(tp_atendimento('88571144303','85481536447',to_timestamp('26/05/2015 17:00:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '88571144303''CESAR'
insert into tb_atendimento values(tp_atendimento('10172073057','08185128731',to_timestamp('26/05/2015 07:30:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '10172073057'TARSILA'    
insert into tb_atendimento values(tp_atendimento('57566231243','85481536447',to_timestamp('05/06/2015 08:00:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '57566231243'MARILIA'
insert into tb_atendimento values(tp_atendimento('56844627238','08185128731',to_timestamp('07/06/2015 09:30:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '56844627238'JANAINA'    
insert into tb_atendimento values(tp_atendimento('84561662197','85481536447',to_timestamp('27/07/2015 10:00:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '84561662197''FLAVIO'
insert into tb_atendimento values(tp_atendimento('51492421448','85481536447',to_timestamp('27/07/2015 11:00:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '51492421448'VALERIA'    
insert into tb_atendimento values(tp_atendimento('01210449390','85481536447',to_timestamp('17/08/2015 12:30:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '01210449390','WILTON'
insert into tb_atendimento values(tp_atendimento('53125548632','08185128731',to_timestamp('17/08/2015 13:30:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '53125548632'VERONICA'              
insert into tb_atendimento values(tp_atendimento('36245802997','85481536447',to_timestamp('14/09/2015 14:30:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '36245802997'CAROLINA'
insert into tb_atendimento values(tp_atendimento('93097207511','08185128731',to_timestamp('14/09/2015 15:30:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '93097207511'MARIANA'      
insert into tb_atendimento values(tp_atendimento('88571144303','85481536447',to_timestamp('28/10/2015 16:00:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '88571144303''CESAR'
insert into tb_atendimento values(tp_atendimento('12084546923','08185128731',to_timestamp('28/10/2015 17:30:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '12084546923''JOÃO'    
insert into tb_atendimento values(tp_atendimento('10172073057','08185128731',to_timestamp('29/11/2015 07:30:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '10172073057'TARSILA'        
insert into tb_atendimento values(tp_atendimento('84561662197','85481536447',to_timestamp('30/11/2015 08:30:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '84561662197''FLAVIO'    
insert into tb_atendimento values(tp_atendimento('57566231243','85481536447',to_timestamp('26/12/2015 09:10:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '57566231243'MARILIA'
insert into tb_atendimento values(tp_atendimento('56844627238','08185128731',to_timestamp('23/12/2015 10:10:00','DD/MM/YYYY HH24:MI:SS')));--cliente pf '56844627238'JANAINA'

/

--inserir atendimentos a clientes pessoa juridica

insert into tb_atendimento values(tp_atendimento('55776472000122','85481536447',to_timestamp('01/12/2014 11:32:00','DD/MM/YYYY HH24:MI:SS')));--cliente pj '55776472000122','Diamantes Lingerie Variedades Ltda','VERONICA'
insert into tb_atendimento values(tp_atendimento('81813655000180','08185128731',to_timestamp('01/12/2014 13:33:00','DD/MM/YYYY HH24:MI:SS')));--cliente pj '81813655000180','Griffes Modas Ltda','TARSILA'
insert into tb_atendimento values(tp_atendimento('96427338000101','85481536447',to_timestamp('02/01/2015 14:01:00','DD/MM/YYYY HH24:MI:SS')));--cliente pj  '96427338000101','Auto Peças Moura Ltda','LEANDRO'
insert into tb_atendimento values(tp_atendimento('54552735000157','08185128731',to_timestamp('02/01/2015 15:31:00','DD/MM/YYYY HH24:MI:SS')));--cliente pj '54552735000157','RM Sistemas Ltda','BRIGIDA'
insert into tb_atendimento values(tp_atendimento('71854793000154','85481536447',to_timestamp('03/02/2015 16:32:00','DD/MM/YYYY HH24:MI:SS')));--cliente pj '71854793000154','Comer Bem Ltda','LUCAS'
insert into tb_atendimento values(tp_atendimento('70228623000100','08185128731',to_timestamp('03/02/2015 17:31:00','DD/MM/YYYY HH24:MI:SS')));--cliente pj '70228623000100','Armarinho do Zeca Ltda', 'Jose Carlos'
insert into tb_atendimento values(tp_atendimento('81326646000165','85481536447',to_timestamp('04/03/2015 18:01:00','DD/MM/YYYY HH24:MI:SS')));--cliente pj '81326646000165','Ivan Varieades Ltda','IVAN GOMES'
insert into tb_atendimento values(tp_atendimento('58112903000144','08185128731',to_timestamp('04/03/2015 07:35:00','DD/MM/YYYY HH24:MI:SS')));--cliente pj '58112903000144','Construtrotora Franquel Ltda','RAQUEL'
insert into tb_atendimento values(tp_atendimento('79562568000156','85481536447',to_timestamp('05/04/2015 08:03:00','DD/MM/YYYY HH24:MI:SS')));--cliente pj '79562568000156','Globo Papelaria Modas Ltda','FATIMA'    
insert into tb_atendimento values(tp_atendimento('55776472000122','85481536447',to_timestamp('05/04/2015 09:32:00','DD/MM/YYYY HH24:MI:SS')));--cliente pj '55776472000122','Diamantes Lingerie Variedades Ltda','VERONICA'
insert into tb_atendimento values(tp_atendimento('81813655000180','08185128731',to_timestamp('06/05/2015 10:31:00','DD/MM/YYYY HH24:MI:SS')));--cliente pj '81813655000180','Griffes Modas Ltda','TARSILA'
insert into tb_atendimento values(tp_atendimento('96427338000101','85481536447',to_timestamp('06/05/2015 11:01:00','DD/MM/YYYY HH24:MI:SS')));--cliente pj  '96427338000101','Auto Peças Moura Ltda','LEANDRO'
insert into tb_atendimento values(tp_atendimento('54552735000157','08185128731',to_timestamp('07/06/2015 12:30:00','DD/MM/YYYY HH24:MI:SS')));--cliente pj '54552735000157','RM Sistemas Ltda','BRIGIDA'
insert into tb_atendimento values(tp_atendimento('71854793000154','85481536447',to_timestamp('07/06/2015 13:32:00','DD/MM/YYYY HH24:MI:SS')));--cliente pj '71854793000154','Comer Bem Ltda','LUCAS'
insert into tb_atendimento values(tp_atendimento('70228623000100','08185128731',to_timestamp('08/07/2015 14:31:00','DD/MM/YYYY HH24:MI:SS')));--cliente pj '70228623000100','Armarinho do Zeca Ltda', 'Jose Carlos'
insert into tb_atendimento values(tp_atendimento('81326646000165','85481536447',to_timestamp('08/07/2015 15:01:00','DD/MM/YYYY HH24:MI:SS')));--cliente pj '81326646000165','Ivan Varieades Ltda','IVAN GOMES'
insert into tb_atendimento values(tp_atendimento('58112903000144','08185128731',to_timestamp('09/08/2015 16:31:00','DD/MM/YYYY HH24:MI:SS')));--cliente pj '58112903000144','Construtrotora Franquel Ltda','RAQUEL'
insert into tb_atendimento values(tp_atendimento('79562568000156','85481536447',to_timestamp('09/08/2015 17:30:00','DD/MM/YYYY HH24:MI:SS')));--cliente pj '79562568000156','Globo Papelaria Modas Ltda','FATIMA'  
...
--novamente efetiva os comandos de inserção no banco de dados; 
commit; 

/ 

--bloco de comando para inserir todos os serviços dos atendimentos realizados e 
--inserir também os registros em arquivo de serviços que envolvem a guarda de documentos 
   ...
   OPEN C_ATENDIMENTO;
     ...
     LOOP 
      ...
      EXIT WHEN C_ATENDIMENTO%NOTFOUND;
          ...
          DBMS_OUTPUT.PUT_LINE(' Data do atendimento: '||TO_CHAR(V_REG_ATENDIMENTO.DATAATENDIMENTO,'DD/MM/YYYY'));         
          ...
          FOR CONT IN 1..4 LOOP
                  ...
                  SELECT to_timestamp(TO_CHAR((V_REG_ATENDIMENTO.DATAATENDIMENTO+NUMTODSINTERVAL(CONT, 'MINUTE')),'DD/MM/YYYY HH24:MI:SS'),'DD/MM/YYYY HH24:MI:SS') 
...
--efetiva os comandos de inserção e atualização executados;  
commit; 
