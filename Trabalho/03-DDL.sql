...
CREATE OR REPLACE TYPE TP_REGISTRO AS OBJECT(
  ...
  ,STATIC FUNCTION fazReferenciaAAlgumRegistro(refServicoDoAtendimento in ref tp_servicodoatendimento) RETURN BOOLEAN  --para garantir relacionamento 1p/1 usar  no contrutor do objeto--para garantir relacionamento 1p/1 usar  no contrutor do objeto
...
create or replace TYPE BODY TP_FUNCIONARIO AS
    ...
    BEGIN
       ...
       retorno:=' Data de Admissão: '||to_char(self.dataadmisao,'DD/MM/YYYY');
